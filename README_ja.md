...
以下の表は、「メンバーとなっているプロジェクトのみを表示」設定が有効なユーザーと通常のユーザーのプロジェクト表示可否を比較したものです。

| 認証が必要 | プロジェクト種別 | メンバー? | 通常ユーザー | **メンバーのみ閲覧可能設定ユーザー** |
|:--------:|:-------------:|:-------:|:----------:|:--------------------:|
| `はい`    | 公開           | はい     | ✅          | ✅                   |
| `はい`    | 公開           | いいえ   | ✅          | ❌                   |
| `はい`    | 非公開          | はい     | ✅          | ✅                   |
...
> ※ 匿名ユーザーがプロジェクトにアクセスできる場合のみ表示されます。
>
> 注意: 管理者ユーザーは「メンバーのみ」設定の影響を受けず、常にすべてのプロジェクトを表示できます。
